...
export default function TreePage() {
  ...
  return (
    <main className="container mx-auto p-6 space-y-6">
      <h1 className="text-4xl font-bold">Tree Pose Calibration</h1>

      {/* Instructions */}
      <p className="text-gray-600">
        Stand upright with arms in front and rounded with feet shoulder width apart.
      ...
      {status === 'calibrating' && (
        <p className="text-blue-600 font-medium">
          Hold your Tree pose... {countdown}s remaining
        </p>
      )}
      {status === 'success' && (
        <p className="text-green-600 font-medium">
          Calibration complete! Great Tree pose.
        </p>
      )}
