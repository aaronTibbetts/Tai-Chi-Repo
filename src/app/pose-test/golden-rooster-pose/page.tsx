...
export default function GoldenRoosterPage() {
  ...
  return (
    <main className="container mx-auto p-6 space-y-6">
      <h1 className="text-4xl font-bold">Golden Rooster Stands on One Leg</h1>

      <p className="text-gray-600">
        Stand on one leg and raise the opposite knee to about hip height.
        Raise the arm on the same side as the lifted knee, and keep the other arm relaxed at your side.
        Keep your spine straight and your standing leg slightly bent.
      ...
      {status === 'calibrating' && (
        <p className="text-blue-600 font-medium">
          Hold Golden Rooster pose... {countdown}s remaining
        </p>
      )}
      {status === 'success' && (
        <p className="text-green-600 font-medium">
          Calibration complete! Great Golden Rooster pose.
        </p>
      )}
