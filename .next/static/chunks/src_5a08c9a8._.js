...
"[project]/src/app/csv-test/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CsvTestPage() {
    ...
    const [csvOutput, setCsvOutput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
                ...
                "CsvTestPage.useEffect": ()=>{
                    ...
                    if (videoRef.current?.srcObject) {
                        videoRef.current.srcObject.getTracks().forEach({
                            "CsvTestPage.useEffect": (track)=>track.stop()
                        }["CsvTestPage.useEffect"]);
                    }
                }
            })["CsvTestPage.useEffect"];
    ...
    const processVideo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CsvTestPage.useCallback[processVideo]": (isRec)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$pose$2d$estimation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processVideo"])(videoRef.current, poseLandmarkerRef.current, {
                "CsvTestPage.useCallback[processVideo]": (result, timestamp)=>{
                    if (isRec && result.landmarks && result.landmarks.length > 0) {
                        setLandmarkData({
                            "CsvTestPage.useCallback[processVideo]": (prev)=>[
                                    ...prev,
                                    {
                        ...
                        }["CsvTestPage.useCallback[processVideo]"]);
                    }
                }
            }["CsvTestPage.useCallback[processVideo]"], lastVideoTime);
            animationFrameId.current = requestAnimationFrame({
                "CsvTestPage.useCallback[processVideo]": ()=>processVideo(isRec)
            }["CsvTestPage.useCallback[processVideo]"]);
        }
    }["CsvTestPage.useCallback[processVideo]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CsvTestPage.useEffect": ()=>{
            if (hasCameraPermission && videoRef.current) {
                cancelAnimationFrame(animationFrameId.current);
                animationFrameId.current = requestAnimationFrame({
                    "CsvTestPage.useEffect": ()=>processVideo(isRecording)
                }["CsvTestPage.useEffect"]);
            } else {
                cancelAnimationFrame(animationFrameId.current);
            }
            return ({
                "CsvTestPage.useEffect": ()=>cancelAnimationFrame(animationFrameId.current)
            })["CsvTestPage.useEffect"];
        }
    }["CsvTestPage.useEffect"], [
        hasCameraPermission,
    ...
    const startRecording = ()=>{
        ...
        toast({
            ...
            description: 'Move around to capture pose data.'
        });
    };
    const stopRecording = ()=>{
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                            children: "CSV Generation Test"
                        }, void 0, false, {
                            fileName: "[project]/src/app/csv-test/page.tsx",
                            lineNumber: 181,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                            children: "Test the MediaPipe data capture and CSV conversion process. Start recording, move around, then stop to see the generated CSV and download the compressed JSON."
                        }, void 0, false, {
                            fileName: "[project]/src/app/csv-test/page.tsx",
                            lineNumber: 182,
                            columnNumber: 11
...
_s(CsvTestPage, "eoBEtZj63K4J7P841ip+cRKpLCA=", false, function() {
    return [
...
_c = CsvTestPage;
var _c;
__turbopack_context__.k.register(_c, "CsvTestPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_5a08c9a8._.js.map