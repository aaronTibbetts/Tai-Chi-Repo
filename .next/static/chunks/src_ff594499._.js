...
function ThemeProvider({ children }) {
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ThemeProvider.useMemo[value]": ()=>({
                theme,
                setTheme: ({
                    "ThemeProvider.useMemo[value]": (newTheme)=>{
                        localStorage.setItem('theme', newTheme);
                        setTheme(newTheme);
                    }
                })["ThemeProvider.useMemo[value]"],
...
"[project]/src/lib/auth-storage.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            try {
                const flag = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AUTH_STORAGE_KEYS"].loggedIn);
    ...
    const setAuthenticated = (v)=>{
        ...
        try {
            if (v) localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AUTH_STORAGE_KEYS"].loggedIn, 'true');
            else localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AUTH_STORAGE_KEYS"].loggedIn);
        } catch  {
        /* ignore */ }
    };
    const logout = async ()=>{
...
function Header() {
    ...
    const { isAuthenticated, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Header, "xT+seQBG2LVkgOW/CFjGz+P1ols=", false, function() {
    return [
...
//# sourceMappingURL=src_ff594499._.js.map